...
int main()
{
	//This first question decides if the user will branch into the Hero or the Villain side of the quiz.
	string answer;
...
void Villain() //Justin's code
{
	...
	string line, file_location = ("C:\\Users\\Ian\\CS172\\");
...
void makeAChoice(vector<char> &Option1, vector<char> &Option2, Character &User, int i)
{
	...
	do
	{
		...
		else if (choice == Option2[i])
		{
			...
			cout << "Something valid must be entered!" << endl;
